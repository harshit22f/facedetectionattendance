...
img1 = face_recognition.load_image_file('hrithik.jpg')
img1 = cv2.cvtColor(img1, cv2.COLOR_BGR2RGB)
img1Test = face_recognition.load_image_file('shahrukh.jpg')
...
cv2.imshow('Actor', img1)
cv2.imshow('Actor Test', img1Test)
cv2.waitKey(0)
